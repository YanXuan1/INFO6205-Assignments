...
public class SortTimeTestMain {
    ...
    public Integer[] createOrdered(int len){
        ...
        testOrdered[0] = (int)(Math.random() * 100) / 10;
        for(int k = 1; k<len;k++){
            testOrdered[k] = testOrdered[k - 1] + (int)(Math.random() * 100);
        }
    ...
    public Integer[] createReversed(int len){
        ...
        createReversed[0] = (int)(Math.random() * 100000);
        for(int k = 1; k<len;k++){
            createReversed[k] = createReversed[k - 1] - (int)(Math.random() * 100);
        }
        //System.out.println("The reserved array is : " + Arrays.toString(createReversed));
