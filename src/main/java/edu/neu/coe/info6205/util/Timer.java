...
public class Timer {
    ...
    private static double toMillisecs(long ticks) {
        // TO BE IMPLEMENTED
        //long millTicks = TimeUnit.NANOSECONDS.toMillis(ticks);
        long millTicks = TimeUnit.MILLISECONDS.convert(ticks, TimeUnit.NANOSECONDS);
        return millTicks;
    }
